 ...
 * @author krawler-user
 */
public class LocaleJsServlet extends HttpServlet {

    MessageSource ms = new EscapedMessageSource();
    ...
    public void doGet(HttpServletRequest req, HttpServletResponse resp)
        ...
        byte[] buffer = getContents(locale);
        out.write(buffer);
        out.close();
    }
...
//                + "};"
                ...
                + "   });"
                + "}"
                + "if(Wtf.common.pPageSize){"
                + "   Wtf.apply(Wtf.common.pPageSize.prototype, {"
                + "      beforeText : \"" + this.ms.getMessage("toolbar.paging.pagesize.before.show", params, "", locale) + "\","
                + "      aftertText : \"" + this.ms.getMessage("toolbar.paging.pagesize.after.items", params, "", locale) + "\""
                + "   });"
                + "}";
        return str.getBytes();
    }
    ...
    private static class EscapedMessageSource implements MessageSource {
        ...
        public String getMessage(String code, Object[] args, Locale locale) throws NoSuchMessageException {
            return StringEscapeUtils.escapeJavaScript(MessageSourceProxy.getMessage(code, args, locale));
        }

        @Override
        public String getMessage(String code, Object[] args, String defaultMessage, Locale locale) {
            return StringEscapeUtils.escapeJavaScript(MessageSourceProxy.getMessage(code, args, defaultMessage, locale));
        }
    }
}
