...
*/
package com.krawler.common.listeners;
...
public class LocaleResolverListener implements ServletRequestListener {
    ...
    private static final Log log = LogFactory.getLog(LocaleResolverListener.class);
    ...
    public void requestInitialized(ServletRequestEvent sre) {
        ...
        if (request != null && context != null) {
            ...
            log.debug("Locale resolver cannot be associated with request [request:" + request + ",context:" + context + "]");
        }
    }
}
