...
import com.krawler.esp.fileparser.excel.MsExcelParser;
import com.krawler.esp.fileparser.excel.XlsxParser;
import com.krawler.esp.fileparser.pdf.KWLPdfParser;
import com.krawler.esp.fileparser.ppt.MsPPTParser;
import com.krawler.esp.fileparser.word.DocxParser;
import com.krawler.esp.fileparser.word.ExtractWordFile;
import com.krawler.esp.fileparser.word.FastSavedException;
...
public class CreateIndex {
		...
		try {
			...
			if (contentType.equals("application/vnd.ms-excel")) {
                ...
                plaintext = pdfParse.getPlaintextpdf(filePath);
					...
					|| contentType.equals("text/cs")
					|| contentType.equals("text/x-javascript")
			...
			ArrayList<DocumentFields> docfieldArray = kwlIndex
					.setDocFields(fileDetails);
	...
	public static void main(String argv[]) {
		...
		// ci.IndexDocument("c:\\MSDE2kLog.txt", "", "", "2", "", "");
		// ci.IndexDocument("c:\\2.pdf","","","","1");
