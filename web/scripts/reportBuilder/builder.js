...
Wtf.extend(Wtf.reportBuilder.label, Wtf.BoxComponent, {
    ...
    onRender: function(conf){
        ...
        this.editLink.href = "#";
        this.editLink.innerHTML = WtfGlobal.getLocaleText('lang.edit.text');
    ...
    editLinkClicked: function(){
        var newHtml = WtfGlobal.getLocaleText('pm.common.save')
        if(this.editLink.innerHTML != WtfGlobal.getLocaleText('lang.edit.text'))
            newHtml = WtfGlobal.getLocaleText('lang.edit.text');
...
Wtf.extend(Wtf.reportBuilder.containerPanel, Wtf.Panel, {
    ...
    initComponent: function(conf){
        Wtf.reportBuilder.containerPanel.superclass.initComponent.call(this, conf);
    },
...
Wtf.reportBuilder.builderPanel = function(conf){
    Wtf.apply(this, conf);
//    this.tbar = [{
//        text: WtfGlobal.getLocaleText('pm.common.subTitle'),
//        handler: this.addSubTitle
//    }];
...
Wtf.extend(Wtf.reportBuilder.builderPanel, Wtf.Panel, {
    ...
    autoScroll: true,
    initComponent: function(conf){
        Wtf.reportBuilder.builderPanel.superclass.initComponent.call(this, conf);
    },
