...
function signUpUser(u, p, eml, cn, cdomain, fn, ln){
...
function sValidateEmpty(){
    ...
    if (msg == "") {
        signUpUser(trimStr(usr.value), p1.value, trimStr(eml.value), trimStr(cname.value), trimStr(cdomain.value), trimStr(fname.value), trimStr(lname.value));
		clearErrorMsg();
    }
    else {
