...
<%@ page  import="com.krawler.common.timezone.*"%>
            ...
            if (sessionbean.validateSession(request, response)) {
                try {
                    ...
                    try {
                        ...
                        jbj.put("valid", true);
                        jbj.put("data", "");
                        //jbj.put("data", dbcon.insertChatmessages(sid, rid, m,
                        //	rsflagint, rdflag));
                        ...
                        jpub.append("data", "{'data':[{mode : 'msg', timestamp :'" + time +"' ,message:'" + m + "',id:'" + sid + "',uname:'" + AuthHandler.getUserName(request) + "'}]}");
